...
ALTER TABLE event ADD CONSTRAINT FK_EVENT_ROOM FOREIGN KEY (room)REFERENCES room;
...
INSERT into teaches values('co.CA','co72033.L01');
...
--TriggerOk
insert into staff(name) values ('Angel, Dr Juan');
insert into staff(name) values ('Rojas, Prof Camilo');
insert into staff(name) values ('Gomez, Daniel');
update staff set name='Angel, Juan' where id='co.AJ';
update staff set name='Rojas, Dr Camilo' where id='co.RC';
update staff set name='Gomez, Dr Daniel' where id='co.GD';

--TriggerNoOK
/*
update staff set name='Angel, Dr Jaime' where id='co.AJ';
update staff set name='Aguilar, Prof Juan' where id='co.AJ';
update staff set name='Angel, Jaime' where id='co.AJ';
