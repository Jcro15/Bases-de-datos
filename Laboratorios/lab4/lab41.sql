...
begin
    ...
    elsif  (:old.estado='T'or :old.estado='A')and (:old.justificacion!=:new.justificacion or :old.estado!=:new.estado) and (:new.estado!='A' or :old.estado!='T')   then
            RAISE_APPLICATION_ERROR(-20003,'Para actualizar una validacion debe estar en proceso');
    elsif :new.estado='T' and ((:old.justificacion is null and :new.justificacion is null) or  contador<1) THEN
            RAISE_APPLICATION_ERROR(-20004,'Para que una validacon este terminada debe tener minimo una justificacon y una evidencia ');
...
--Validacion
insert into Validaciones values(1,'10/Jul/2015','Excelente','T','Jorge@mail.com','Jimena@mail.com',1);
--insert into Validaciones values(2,'25/JUN/2016','Mucha experiencia','T','comunicaciones@saldarriaga.org','Jorge@mail.com',2);
insert into Validaciones values(2,'15/JUL/2017','Buenas capacidades','A','Jimena@mail.com','Carlos@mail.com',3);
insert into Validaciones values(3,'10/Jul/2015',NULL,'T','Jorge@mail.com','Carlos@mail.com',2);
insert into Validaciones values(4,'10/Jul/2015',NULL,'T','Jorge@mail.com','Carlos@mail.com',3);
--Validacion
